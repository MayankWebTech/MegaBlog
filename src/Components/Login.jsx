...
function Login() {
  ...
  return (
    <div className='flex items-center justify-center w-full my-6'>
        ...
        <h2 className='text-center text-customBlue text-2xl font-bold leading-tight'>Sign in to your account</h2>
        ...
        className="mt-8">
            <div className='space-y-5'>
                ...
                <Button type="Submit" className='w-full active:bg-customWhite active:text-customBlue active:text-lg'>Sign in</Button>
            </div>
        </form>
        </div>
    </div>
